...
<div id="main content">
        ...
        <div id="about-main">
            ...
            <div class="team-member">
                ...
                <li><h3>Claire Carpenter (aka CC), CEO of WP, Lead Photographer</h3>
                <br><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sodales lectus efficitur, cursus sapien in, vulputate ipsum. In sollicitudin nibh in fringilla aliquet. Aenean bibendum ornare elit et maximus. Nulla in condimentum lacus. Vestibulum dapibus, dui ut vulputate tempor, turpis eros eleifend ipsum, ac tincidunt turpis ipsum id urna. Morbi sed vestibulum ex. Fusce non pharetra magna, vitae mattis tellus.</p></li>
            </div>
            ...
            <div class="team-member">
                <li>
                   ...
                   <li> <h3>Aaron Carpenter (aka CC), Co-CEO of WP, Accountant, also Claire's hubby.</h3>
            ...
            <div class="team-member">
                <li>
                    <img src="${editorPic}" alt="photo of Assistant Photographer and Editor">
                </li>
                   <li> <h3>Mariyah Washington, Graphic Designer & Editor</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sodales lectus efficitur, cursus sapien in, vulputate ipsum. In sollicitudin nibh in fringilla aliquet. Aenean bibendum ornare elit et maximus. Nulla in condimentum lacus. Vestibulum dapibus, dui ut vulputate tempor, turpis eros eleifend ipsum, ac tincidunt turpis ipsum id urna. Morbi sed vestibulum ex. Fusce non pharetra magna, vitae mattis tellus.</p>
                   </li>
            </div>
            ...
            <div class="team-member">
                <li>
                   ...
                   <li> <h3>Lisa Wong, Makeup Artist & Social Manager</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sodales lectus efficitur, cursus sapien in, vulputate ipsum. In sollicitudin nibh in fringilla aliquet. Aenean bibendum ornare elit et maximus. Nulla in condimentum lacus. Vestibulum dapibus, dui ut vulputate tempor, turpis eros eleifend ipsum, ac tincidunt turpis ipsum id urna. Morbi sed vestibulum ex. Fusce non pharetra magna, vitae mattis tellus.</p>
                </li>
            </div>
            ...
            <div class="team-member">
                <li>
                   ...
                   <li><h3>Mike Smith, Set & Lighting Expert</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sodales lectus efficitur, cursus sapien in, vulputate ipsum. In sollicitudin nibh in fringilla aliquet. Aenean bibendum ornare elit et maximus. Nulla in condimentum lacus. Vestibulum dapibus, dui ut vulputate tempor, turpis eros eleifend ipsum, ac tincidunt turpis ipsum id urna. Morbi sed vestibulum ex. Fusce non pharetra magna, vitae mattis tellus.</p>
                </li>
            </div>
            <div class="team-member">
                <li>
                   ...
                   <li><h3>Jakob Williams, Videographer</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sodales lectus efficitur, cursus sapien in, vulputate ipsum. In sollicitudin nibh in fringilla aliquet. Aenean bibendum ornare elit et maximus. Nulla in condimentum lacus. Vestibulum dapibus, dui ut vulputate tempor, turpis eros eleifend ipsum, ac tincidunt turpis ipsum id urna. Morbi sed vestibulum ex. Fusce non pharetra magna, vitae mattis tellus.</p>
                </li>
            </div>
            ...
            <div class="team-member">
                <li>
                   ...
                   <li> <h3>Carly, Emotional Support Animal, Professional Cuddle Buddy</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sodales lectus efficitur, cursus sapien in, vulputate ipsum. In sollicitudin nibh in fringilla aliquet. Aenean bibendum ornare elit et maximus. Nulla in condimentum lacus. Vestibulum dapibus, dui ut vulputate tempor, turpis eros eleifend ipsum, ac tincidunt turpis ipsum id urna. Morbi sed vestibulum ex. Fusce non pharetra magna, vitae mattis tellus.</p>
                </li>
            </div>
